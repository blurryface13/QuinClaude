...
from quin_claude.cli.commands.chat import cmd_chat
from quin_claude.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from quin_claude.cli.commands.ping import cmd_ping
from quin_claude.cli.commands.run import cmd_run
from quin_claude.cli.commands.trace import cmd_trace
from quin_claude.cli.commands.version import cmd_version
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="quin", description="QuinClaude CLI")
