...
from quin_claude.core.bus.events import RunFinishedEvent, RunStartedEvent
from quin_claude.core.compact.compactor import Compactor
from quin_claude.core.config import QuinConfig
from quin_claude.core.context import ExecutionContext
from quin_claude.core.events.bus import EventBus, EventHandler
from quin_claude.core.events.writer import EventWriter
from quin_claude.core.llm.base import LLMProvider
from quin_claude.core.llm.provider import create_provider
from quin_claude.core.loop import AgentLoop
from quin_claude.core.mcp.server import McpServerManager
from quin_claude.core.memory.loader import load_context_file
from quin_claude.core.permissions.manager import PermissionManager
from quin_claude.core.runs import RUNS_DIR, new_run_id
from quin_claude.core.session.model import Session
from quin_claude.core.session.store import SessionStore
from quin_claude.core.subagent.registry import BackgroundTaskRegistry
from quin_claude.core.subagent.tool import AgentResultTool, SpawnAgentTool
from quin_claude.core.task.manager import TaskManager
from quin_claude.core.tools.builtin import (
    BashTool,
    ListDirTool,
    NoteSaveTool,
    ReadFileTool,
...
from quin_claude.core.tools.registry import ToolRegistry
from quin_claude.core.trace.provider import TracingProvider
from quin_claude.core.trace.writer import TraceWriter
...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        global_ctx = load_context_file(Path("~/.quin/context.md").expanduser())
        project_ctx = load_context_file(Path(".quin/context.md"))
